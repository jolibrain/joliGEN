...
*Schematic representation of an image-to-image GAN architecture*, from https://arxiv.org/abs/2007.15651
...
*Illustration of the process of image transformation using image-to-image GANs*
...
*Example of practical application of DDPMs in image-to-image generative task*

DDPMs allow for fine-grained control of image generation, via conditioning. This is critical to industrial use-cases, allowing for careful controled generation, even outside the perimeter of the training set.

.. image:: _static/ddpm_traffic_cats.png
*Fine-grained control of DDPM out-of-domain generation: meow traffic sign*
...
* If your application is style transfer while preserving certain elements (e.g. change wheather but conserve main scene), use GANs
