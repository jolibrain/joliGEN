    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            if self.opt.use_contrastive_loss_D:
                self.group_D = NetworkGroup(networks_to_optimize=["D_A","D_B"],forward_functions=None,backward_functions=["compute_D_contrastive_loss"],loss_names_list=["loss_names_D"],optimizer=["optimizer_D"],loss_backward="loss_D")
            else:
