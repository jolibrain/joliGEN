...
class ECTModel(BaseDiffusionModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            parser = ECTModel.modify_commandline_options_train(parser)
    ...
    def __init__(self, opt, rank):
        ...
        opt.alg_diffusion_cond_embed_dim = 32  # 256
        ...
        self.group_G = NetworkGroup(
            ...
            forward_functions=[],
            backward_functions=["compute_ect_loss"],
        ...
        ############
        # ------------------------------
        # ECT tick-based stage schedule
        # ------------------------------
        self.cur_tick = 0
        self.cur_nimg = 0
        self.tick_start_nimg = 0
        self.kimg_per_tick = 50  # 1 tick = 50k images (adjustable)
        # self.total_kimg = 2000        # total training length
        # self.double_ticks = getattr(opt, "double_ticks", 1000)  # keep consistent
