...
from models.modules.mmcv_clean.segformer_head import SegformerHead
from models.modules.mmcv_clean.shape_convert import nlc_to_nchw, nchw_to_nlc, to_2tuple
...
class MixFFN(nn.Module):
    ...
    def __init__(
        ...
        self.dropout_layer = (
            nn.Dropout(dropout_layer["drop_prob"])
            if dropout_layer
