...
class SCGenerator(nn.Module):
    ...
    def sc_forward(self, x_t, t, dt, x_cond=None):
        ...
        #        print(
        #            "  input to NN  shape x_with_cond embed_t_dt",
        #            x_with_cond.shape,
        #            embed_t_dt.shape,
        #        )
    ...
    def restoration(
        self, y, y_cond, sampling_sigmas=None, mask=None, clip_denoised=True
    ):
        """
        Deterministic restoration using the learned shortcut consistency flow.
        Similar to sampling in a consistency model.
        """
        ...
        denoise_timesteps_list = [1, 2, 4, 8, 16, 32, 64, 128]

        denoise_timesteps = denoise_timesteps_list[4]
